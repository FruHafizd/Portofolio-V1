            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                ...
                <div class="group relative rounded-xl bg-white/[0.02] border border-white/[0.05] p-6 transition-all duration-300 hover:-translate-y-2 hover:bg-white/[0.05]">
                    <div class="relative z-10">
                        <!-- Project Image with Enhanced Container -->
                        <div class="relative h-48 mb-6 overflow-hidden rounded-lg">
                            <img src="{{ url('img/project-3.png') }}" alt="Project 2" 
                                 class="w-full h-full object-cover transform transition-transform duration-500 group-hover:scale-105">
                            <!-- Minimal Overlay -->
                            <div class="absolute inset-0 bg-gradient-to-t from-[#0A0F1C] opacity-40"></div>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <p class="text-gray-400 text-sm font-['Inter'] leading-relaxed">
                                <p class="text-gray-400 text-sm font-['Inter'] leading-relaxed">
                                    Ecommerce is a fully-featured online store built using Laravel, Filament, and Livewire. This platform enables seamless product management, order processing, and customer interactions directly from an intuitive admin panel. With dynamic real-time updates powered by Livewire, users can efficiently manage their store without page refreshes. Filament’s modern interface provides an elegant and easy-to-use backend experience, while Livewire ensures a smooth, interactive shopping experience for customers.
                                </p>                                
                            </p>
                            ...
                            <!-- Enhanced Footer with Links -->
                            <div class="flex items-center justify-between pt-4 border-t border-white/[0.05]">
                                <a href="https://github.com/FruHafizd/ecommerce" target="_blank" 
                                   class="inline-flex items-center gap-2 text-sm text-gray-400 hover:text-blue-400 transition-colors duration-300 group/link">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0024 12c0-6.63-5.37-12-12-12z"/>
                                    </svg>
