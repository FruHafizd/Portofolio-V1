    ...
    <div class="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-10 py-20">
            ...
            <div class="text-center mb-16">
                ...
                <p class="text-gray-400 mt-6 max-w-2xl mx-auto font-['Inter'] animate-fadeIn">
            ...
            <div class="max-w-6xl mx-auto">
                <div class="space-y-8">
                    ...
                    <!-- Education Item 2 -->
                    {{-- <div class="relative pl-8 py-6 group hover:bg-white/5 rounded-lg transition-all duration-300 transform hover:scale-[1.02] shadow-lg">
                        <div class="absolute left-0 top-1/2 transform -translate-y-1/2 w-1 h-full bg-gradient-to-b from-purple-500 to-purple-700 group-hover:h-[120%] transition-all duration-300"></div>
                        <div class="flex flex-col md:flex-row md:items-center gap-4">
                            <div class="flex-1">
                                <span class="text-purple-400 text-sm font-semibold tracking-wider">2018 - 2020</span>
                                <h3 class="text-xl font-bold mt-2 font-['Montserrat'] text-white">High School Diploma</h3>
                                <h4 class="text-purple-300 font-semibold mt-1">School Name</h4>
                                <p class="text-gray-400 mt-3 font-['Inter']">
                                    Graduated with honors. Active participant in programming club and mathematics olympiad.
                                </p>
                            </div>
                            <div class="flex items-center gap-2">
                                <div class="px-4 py-2 rounded-full bg-purple-500/10 text-purple-400 text-sm">Science</div>
                                <div class="px-4 py-2 rounded-full bg-blue-500/10 text-blue-400 text-sm">Mathematics</div>
                            </div>
                        </div>
                    </div> --}}
                </div>
