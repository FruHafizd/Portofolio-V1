<div class="space-y-4 sticky top-0 backdrop-blur-md drop-shadow-2xl z-50">
    <header class="flex flex-wrap sm:justify-start sm:flex-nowrap w-full text-sm py-3">
      <nav class="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between">
        <div class="flex items-center justify-between">
          <a class="flex-none text-2xl font-bold text-white focus:outline-none focus:opacity-80" href="#">Fru Ha</a>
          <div class="sm:hidden">
