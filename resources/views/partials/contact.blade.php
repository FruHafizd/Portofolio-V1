...
<section class="mb-36">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            ...
            <!-- Email Card -->
            <div
                class="group relative overflow-hidden rounded-xl bg-gradient-to-br from-[#1E3A8A]/10 to-[#3B82F6]/5 p-6 backdrop-blur-sm transition-all duration-300 hover:transform hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-500/20 border border-white/10">
                <div
                ...
                <div class="relative z-10">
                    <div
                        class="mb-4 w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-700 rounded-lg flex items-center justify-center shadow-lg">
                    ...
                    <p class="text-blue-200/80 text-sm mb-4">Contact me via email</p>
                    <a href="mailto:muhammadhafizd876@gmail.com"
                        class="inline-flex items-center text-sm text-white hover:text-blue-300 transition-colors">
                        muhammadhafizd876@gmail.com
            ...
            <div
                ...
                <div class="relative z-10">
                    ...
                    <h3 class="text-xl font-semibold text-white mb-2">GitHub</h3>
                    <p class="text-blue-200/80 text-sm mb-4">Check out my project on GitHub</p>
                    <a href="https://github.com/FruHafizd" target="_blank" rel="noopener noreferrer"
                        class="inline-flex items-center text-sm text-white hover:text-blue-300 transition-colors">
                        github.com/FruHafizd
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M14 5l7 7m0 0l-7 7m7-7H3" />
            ...
            <div
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-blue-200/80 text-sm mb-4">Ikuti saya di Instagram</p>
                    <a href="https://instagram.com/fruha82" target="_blank" rel="noopener noreferrer"
                        class="inline-flex items-center text-sm text-white hover:text-blue-300 transition-colors">
                        @fruha82
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
